...
#if defined(CONFIG_SKY_SND_FAB2210)
...
static void __init apq8064_reserve(void)
{
	...
	pantech_ram_console_debug_reserve(SZ_1M);
#endif

#ifdef CONFIG_F_SKYDISP_RESERVE_LK_FRAMEBUF
    // Sometimes, LK Framebuf area is written by someone before android boot animation.
    // Therefore, remove LK Framebuf from memblock and then LK Framebuf is not accessible by kerenl.
    #define LK_FRAMEBUF_ADDR 0x89000000
#if defined(CONFIG_MACH_APQ8064_EF48S) ||defined(CONFIG_MACH_APQ8064_EF49K) || defined(CONFIG_MACH_APQ8064_EF50L)	
    #define LK_FRAMEBUF_SIZE SZ_1M*3 // It's for 1280*720*3
#elif defined(CONFIG_MACH_APQ8064_EF51S) || defined(CONFIG_MACH_APQ8064_EF51L)    // p14682 for 1920 * 1080 * 3
	#define LK_FRAMEBUF_SIZE SZ_1M*7 // It's for 1280*720*3
#else
	#define LK_FRAMEBUF_SIZE SZ_1M // It's for 1280*720*3
#endif 

    //memblock_dump_all();
    printk("memblock_is_region_memory() of LK Framebuf(0x%x):%d(1 means success)\n"
        ,LK_FRAMEBUF_ADDR ,memblock_is_region_memory(LK_FRAMEBUF_ADDR, LK_FRAMEBUF_SIZE));
        
    printk("memblock_remove() for LK Framebuf:%lu(0 means success)\n", 
        memblock_remove(LK_FRAMEBUF_ADDR, LK_FRAMEBUF_SIZE));
#endif
}
...
static struct platform_device *common_devices[] __initdata = {
    ...
    &msm_device_tsif[0], // EF48/49/50 use TSIF PORT1
#else
    &msm_device_tsif[1],
...
static void __init apq8064_common_init(void)
{
	...
	if (machine_is_apq8064_mtp()
	  ...
	  || (machine_is_apq8064_ef48s() || machine_is_apq8064_ef49k() || machine_is_apq8064_ef50l() || machine_is_apq8064_ef51s() || machine_is_apq8064_ef51l() )
		...
		/* 2012.09.05 EHCI: HCD: Set interrupt threshold value per controller basis */
