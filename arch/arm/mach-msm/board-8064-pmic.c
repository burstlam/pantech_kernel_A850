...
#ifndef CONFIG_CONT_SPLASH_SKY_BOOT_IMAGE
	PM8921_GPIO_OUTPUT(14, 1, HIGH),	/* HDMI Mux Selector */
#endif
	//PM8921_GPIO_OUTPUT(23, 0, HIGH),	/* touchscreen power FET */ //p13795 this is NC pin
	PM8921_GPIO_OUTPUT_BUFCONF(25, 0, LOW, CMOS), /* DISP_RESET_N */
#ifndef CONFIG_CONT_SPLASH_SKY_BOOT_IMAGE
	PM8921_GPIO_OUTPUT_FUNC(26, 0, PM_GPIO_FUNC_2), /* Bl: Off, PWM mode */
#endif

	//PM8921_GPIO_OUTPUT_VIN(30, 1, PM_GPIO_VIN_VPH), /* SMB349 susp line *///p13795 this is NC pin
	PM8921_GPIO_OUTPUT_BUFCONF(36, 1, LOW, OPEN_DRAIN),
	PM8921_GPIO_OUTPUT_FUNC(44, 0, PM_GPIO_FUNC_2),
	PM8921_GPIO_OUTPUT(33, 0, HIGH),
	//PM8921_GPIO_OUTPUT(20, 0, HIGH),//p13795 this is NC pin
	//PM8921_GPIO_INPUT(35, PM_GPIO_PULL_UP_30),//p13795 this is NC pin
	PM8921_GPIO_INPUT(38, PM_GPIO_PULL_UP_30),
	/* TABLA CODEC RESET */
	PM8921_GPIO_OUTPUT(34, 1, MED),
    PM8921_GPIO_INPUT(31, PM_GPIO_PULL_NO),
    //PM8921_GPIO_OUTPUT(13, 0, HIGH),               /* PCIE_CLK_PWR_EN */ //p13795 This is NC pin
...
#elif defined(CONFIG_MACH_APQ8064_EF51S)
...
static struct pm8xxx_mpp_init pm8xxx_mpps[] __initdata = {
	...
	PM8921_MPP_INIT(2, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH6, AOUT_CTRL_DISABLE),
#endif
#ifdef CONFIG_PANTECH_ANDROID_OTG
        PM8921_MPP_INIT(3, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH6, AOUT_CTRL_DISABLE),
#else
...
#endif
//#ifdef CY_USE_TMA463
	{"touch_id", ADC_MPP_1_AMUX8, CHAN_PATH_SCALING1, AMUX_RSV1,
        ADC_DECIMATION_TYPE2, ADC_SCALE_DEFAULT},
//#endif
...
//#define CHG_TERM_MA		100 1035A error
static struct pm8921_charger_platform_data
apq8064_pm8921_chg_pdata __devinitdata = {
	.safety_time		= 180,
	.update_time		= 60000,
