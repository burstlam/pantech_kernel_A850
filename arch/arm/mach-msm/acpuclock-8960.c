...
#if defined (CONFIG_PANTECH_SMB347_CHARGER) //p14978, if offline charging, nr_cpu=1
static struct acpu_level acpu_freq_tbl_8064_slow_offline[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   950000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   950000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   975000 },
	//{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   975000 },
...
static struct acpu_level acpu_freq_tbl_8064_nom_offline[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   900000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   900000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   925000 },
	//{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   925000 },
...
static struct acpu_level acpu_freq_tbl_8064_fast_offline[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   850000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   850000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   875000 },
	//{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   875000 },
...
#if defined (CONFIG_PANTECH_SMB347_CHARGER)//p14978, if offline charging, nr_cpu=1
static struct acpu_level *acpu_freq_tbl_8064_offline[NUM_PVS] __initdata = {
	[PVS_SLOW] = acpu_freq_tbl_8064_slow_offline,
	[PVS_NOM] = acpu_freq_tbl_8064_nom_offline,
	[PVS_FAST] = acpu_freq_tbl_8064_fast_offline,
	[PVS_FASTER] = acpu_freq_tbl_8064_fast_offline,
};
#endif
...
//20120619 so2firethread. offline charging current
	...
	if (cpu_is_msm8960()) {
		...
		scalable = scalable_8064;
			...
			if(pantech_charging_status())
				acpu_freq_tbl = acpu_freq_tbl_8064_offline[pvs_id];
			else
