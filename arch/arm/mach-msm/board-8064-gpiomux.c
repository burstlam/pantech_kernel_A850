...
#else	// 72 use backtouch interrupt pin - EF51S, EF51L
{
	.gpio = 33,	
	.settings = {
		[GPIOMUX_ACTIVE]	= &hdmi_active_2_cfg,
...
struct msm_gpiomux_config apq8064_touch_config[] = {
	...
	{	/* TS RESET */
#if CONFIG_BOARD_VER >= CONFIG_PT10 && !(defined(CONFIG_MACH_APQ8064_EF50L) || defined(CONFIG_MACH_APQ8064_EF51L))
		.gpio = 43,
...
#if defined(CONFIG_TOUCHSCREEN_PP8360) && (defined(CONFIG_MACH_APQ8064_EF51L) || defined(CONFIG_MACH_APQ8064_EF51S))
static struct gpiomux_setting gpio_back_touch_act_config = {
	.pull = GPIOMUX_PULL_UP,
	.drv = GPIOMUX_DRV_8MA,
	.func = GPIOMUX_FUNC_GPIO,
};

static struct gpiomux_setting gpio_back_touch_sus_config = {
	.pull = GPIOMUX_PULL_UP,
	.drv = GPIOMUX_DRV_2MA,
	.func = GPIOMUX_FUNC_GPIO,
};
...
struct msm_gpiomux_config apq8064_back_touch_config[] = {
	{  /*BACK_TOUCH INT */
		.gpio = 72,
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_back_touch_act_config,
			[GPIOMUX_SUSPENDED] = &gpio_back_touch_sus_config,
		}
	},
	{	/* BACK_TOUCH RESET */
		.gpio = 62,
...
static struct msm_gpiomux_config apq8064_unused_gpio_configs[] __initdata = {
	/*{
		.gpio      = 13,			// T802 spare pin 
		.settings = {
			[GPIOMUX_SUSPENDED] = &unused_gpio_cfg,
	    },
    },*/
	{
		.gpio      = 34,			/* T803 spare pin */
		.settings = {
			[GPIOMUX_SUSPENDED] = &unused_gpio_cfg,
		},
	},
	{
		.gpio      = 33,			/* unused gpio pin */
		.settings = {
			[GPIOMUX_SUSPENDED] = &unused_gpio_cfg,
	    },
	},
...
#if defined(CONFIG_TOUCHSCREEN_PP8360) && (defined(CONFIG_MACH_APQ8064_EF51S) || defined(CONFIG_MACH_APQ8064_EF51L)) 
