...
VREG_CONSUMERS(L2) = {
	...
	REGULATOR_SUPPLY("mipi_csi_vdd",	"4-0078"),//"msm_camera_ce1502.0"),
       ...
       REGULATOR_SUPPLY("mipi_csi_vdd",	"4-0090"),//"4-0048"),//"msm_camera_as0260.0"),"4-005d"),//
#endif
...
#ifndef CONFIG_F_SKYDISP_QUALCOMM_FIX_MIPI_OPERATION_BECAUSE_MIPI_DOESNOT_WORK_AT_LOW_TEMP
...
#if defined(CONFIG_PANTECH_LCD_ROHM_APQ8064) || defined(CONFIG_MACH_APQ8064_EF51S)
...
#elif (defined(CONFIG_MACH_APQ8064_EF51S)||defined(CONFIG_MACH_APQ8064_EF51L))
