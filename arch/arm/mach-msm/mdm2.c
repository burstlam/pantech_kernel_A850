...
extern int paiksun_test_resume ;
#endif
#ifdef CONFIG_PANTECH_ERR_CRASH_LOGGING
extern int is_subsystem_restarting;
#endif
...
#ifdef CONFIG_PANTECH
        if(is_subsystem_restarting != 1){
            paiksun_test_resume = 0;
        }
        pr_err("%s: test_resume %d, is_subsystem_restarting : %d\n", __func__, paiksun_test_resume, is_subsystem_restarting);
#endif
