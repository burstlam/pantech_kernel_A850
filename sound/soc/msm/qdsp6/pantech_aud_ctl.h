...
#define PANTECH_AUDIO_GET_BAND_NUM_CTL			_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 5, unsigned)
#define PANTECH_AUDIO_GET_LVL_RANG_MIN_CTL		_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 6, unsigned)
...
#define PANTECH_AUDIO_GET_BASS_BOOST_VALUE_CTL	_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 19, unsigned)
...
#define PANTECH_AUDIO_GET_VIRTUAL_VALUE_CTL		_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 22, unsigned)
#define PANTECH_AUDIO_PRESET_REVERB_CTL			_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 23, unsigned)
#define PANTECH_AUDIO_GET_PRESET_REVERB_CTL		_IOW(PANTECH_AUDIO_IOCTL_MAGIC, 24, unsigned)
