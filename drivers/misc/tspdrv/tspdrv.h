...
/* use the following define to save ts5000 in pt10 board
 */
#define TS5000_SAVING_PT10

#define GPIO_TSP_I2C_SDA    86
#define GPIO_TSP_I2C_SCL    85
...
#ifdef __KERNEL__
    #ifdef VIBE_DEBUG
        #define DbgOut(fmt, args...) printk("%s: %s: " fmt, MODULE_NAME, __func__, ##args)
    #else   /* VIBE_DEBUG */
