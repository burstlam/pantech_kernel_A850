...
#ifndef CONFIG_F_SKYDISP_QUALCOMM_GENLOCK_PATCH
/* 20120818, kkcho, apply genlock-patch form Qualcomm */
#define CONFIG_F_SKYDISP_QUALCOMM_GENLOCK_PATCH
#endif

struct genlock *genlock_create_lock(struct genlock_handle *handle)
{
	struct genlock *lock;
#ifdef CONFIG_F_SKYDISP_QUALCOMM_GENLOCK_PATCH
	void *ret;
#endif
