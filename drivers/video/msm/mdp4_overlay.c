...
#ifdef CONFIG_F_QUALCOMM_BUG_FIX_LCD_MDP_DOWNSCALING_BUG
...
#ifdef CONFIG_F_QUALCOMM_BUG_FIX_LCD_MDP_DOWNSCALING_BUG
/* 20120819, kkcho, resolution infomation.
	1280*720 : 0xE1000
	1280*716 : 0xE0000
	1280*690 : 0xD7A00
*/
...
#if (0) //20120820, kkcho, for EF50L_2175, EF50L_2273, EF50L_2264  bug-fix
	else if (req->src.width*req->src.height <= 0xD7A00)
	{
		u32 max, min;
