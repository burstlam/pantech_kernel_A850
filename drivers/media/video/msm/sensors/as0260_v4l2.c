...
#if 1	
	{
		.x_output = AS0260_QTR_SIZE_WIDTH,
		.y_output = AS0260_QTR_SIZE_HEIGHT,
		.line_length_pclk = AS0260_QTR_SIZE_WIDTH + AS0260_HRZ_QTR_BLK_PIXELS,
		.frame_length_lines = AS0260_QTR_SIZE_HEIGHT+ AS0260_VER_QTR_BLK_LINES,
#ifdef AS0260_MIPI_2_LANE
		.vt_pixel_clk = 62668800,//48000000,//50000000,
		.op_pixel_clk = 192000000,//128000000,//150000000,
#else
		.vt_pixel_clk = 11520000,//48000000,//50000000,
		.op_pixel_clk = 96000000,//24000000,//128000000,//150000000,
#endif
		.binning_factor = 1,
	},
#else
