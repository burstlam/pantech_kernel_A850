...
#define MSMFB_SKY_LCD_CE_CASE1    _IOW(MSMFB_IOCTL_MAGIC, 165, unsigned int)
#define MSMFB_SKY_LCD_CE_CASE2    _IOW(MSMFB_IOCTL_MAGIC, 159, unsigned int)
#define MSMFB_SKY_LCD_CE_CASE3    _IOW(MSMFB_IOCTL_MAGIC, 160, unsigned int)
#define MSMFB_SKY_LCD_CE_CASE4    _IOW(MSMFB_IOCTL_MAGIC, 161, unsigned int)
#define MSMFB_SKY_LCD_CE_CASE5    _IOW(MSMFB_IOCTL_MAGIC, 162, unsigned int)
#define MSMFB_SKY_LCD_CE_CASE6    _IOW(MSMFB_IOCTL_MAGIC, 163, unsigned int)
#define MSMFB_SKY_LCD_CE_CASE0    _IOW(MSMFB_IOCTL_MAGIC, 164, unsigned int)
#endif
